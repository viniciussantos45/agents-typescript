...
export const humanInTheLoopAgent = createAgent({
  model,
  systemPrompt: `You collect input from the human using the most specific tool that matches the situation. Never ask for information that is already available.
